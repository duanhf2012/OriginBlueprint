...
const migratedSchemas: NodeSchema[] = [
  { id: 'origin.io.file-path', title: 'File', category: 'File', kind: 'function', subtitle: 'File', width: 285, inputs: [{ key: 'path', label: 'path', type: 'string', defaultValue: '', fileMode: 'open' }], outputs: [{ key: 'file', label: 'file', type: 'file' }] },
  { id: 'origin.io.save-file-path', title: 'Save File', category: 'File', kind: 'function', subtitle: 'File', width: 285, inputs: [{ key: 'path', label: 'path', type: 'string', defaultValue: '', fileMode: 'save' }], outputs: [{ key: 'file', label: 'file', type: 'file' }] },
  ...
  { id: 'origin.io.read-text', title: 'Read File', category: 'File', kind: 'flow', subtitle: 'File', width: 245, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'file', label: 'file', type: 'file' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'text', label: 'text', type: 'string' }, { key: 'error', label: 'Failed', type: 'exec' }] },
  { id: 'origin.io.save-text', title: 'Write Text File', category: 'File', kind: 'flow', subtitle: 'File', width: 245, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'file', label: 'file', type: 'file' }, { key: 'text', label: 'text', type: 'string', defaultValue: '' }], outputs: [{ key: 'exec', label: '', type: 'exec' }] },
  { id: 'origin.table.read-csv', title: 'Read Table', category: 'Table', kind: 'flow', subtitle: 'CSV Table', width: 265, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'file', label: 'file', type: 'file' }, { key: 'delimiter', label: 'delimiter', type: 'string', defaultValue: ',' }, { key: 'header', label: 'first row is header', type: 'boolean', defaultValue: true }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }, { key: 'error', label: 'Failed', type: 'exec' }] },
  { id: 'origin.table.save-csv', title: 'Save Table', category: 'Table', kind: 'flow', subtitle: 'CSV Table', width: 260, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }, { key: 'file', label: 'file', type: 'file' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }] },
  { id: 'origin.table.row-count', title: 'Table Rows Count', category: 'Table', kind: 'flow', subtitle: 'Table', inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'count', label: 'rows', type: 'integer' }] },
  { id: 'origin.table.headers', title: 'Table Header', category: 'Table', kind: 'flow', subtitle: 'Table', inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'headers', label: 'headers', type: 'array' }] },
  { id: 'origin.table.merge', title: 'Merge Table', category: 'Table', kind: 'flow', subtitle: 'Table', width: 270, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'left', label: 'left table', type: 'table' }, { key: 'right', label: 'right table', type: 'table' }, { key: 'key', label: 'key', type: 'string', defaultValue: '' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'merged table', type: 'table' }] },
  { id: 'origin.table.select-columns', title: 'Sub Table', category: 'Table', kind: 'flow', subtitle: 'Table', width: 265, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }, { key: 'columns', label: 'columns', type: 'array', defaultValue: [] }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'sub table', type: 'table' }] },
  { id: 'origin.table.print', title: 'Print Table', category: 'Table', kind: 'flow', subtitle: 'Table', inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }] },
  { id: 'origin.table.sort', title: 'Sort Table', category: 'Table', kind: 'flow', subtitle: 'Table', width: 260, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }, { key: 'column', label: 'column', type: 'string', defaultValue: '' }, { key: 'ascending', label: 'ascending', type: 'boolean', defaultValue: true }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'sorted table', type: 'table' }] },
  { id: 'origin.table.filter-equal', title: 'Filter Table Equal', category: 'Table', kind: 'flow', subtitle: 'Table', width: 275, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }, { key: 'column', label: 'column', type: 'string', defaultValue: '' }, { key: 'value', label: 'value', type: 'any' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'filtered table', type: 'table' }] },
  { id: 'origin.table.rename-column', title: 'Rename Table Column', category: 'Table', kind: 'flow', subtitle: 'Table', width: 275, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }, { key: 'from', label: 'from', type: 'string', defaultValue: '' }, { key: 'to', label: 'to', type: 'string', defaultValue: '' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }] },
  { id: 'origin.table.drop-columns', title: 'Drop Table Columns', category: 'Table', kind: 'flow', subtitle: 'Table', width: 270, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }, { key: 'columns', label: 'columns', type: 'array', defaultValue: [] }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }] },
  { id: 'origin.table.fill-empty', title: 'Fill Empty Cells', category: 'Table', kind: 'flow', subtitle: 'Table', width: 265, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }, { key: 'value', label: 'replacement', type: 'any' }], outputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }] },
  { id: 'origin.table.get-column', title: 'Get Table Column', category: 'Table', kind: 'function', subtitle: 'Table', inputs: [{ key: 'table', label: 'table', type: 'table' }, { key: 'column', label: 'column', type: 'string', defaultValue: '' }], outputs: [{ key: 'values', label: 'values', type: 'array' }] },
  ...
  { id: 'origin.flow.foreach-table-row', title: 'For Each Table Row', category: 'Flow Control', kind: 'flow', subtitle: 'Table Loop', width: 270, inputs: [{ key: 'exec', label: '', type: 'exec' }, { key: 'table', label: 'table', type: 'table' }], outputs: [{ key: 'body', label: 'Loop Body', type: 'exec' }, { key: 'completed', label: 'Completed', type: 'exec' }, { key: 'row', label: 'row', type: 'dictionary' }, { key: 'index', label: 'index', type: 'integer' }] },
  { id: 'origin.table.preview', title: 'Preview Table', category: 'Table', kind: 'function', subtitle: 'Table Preview', width: 250, inputs: [{ key: 'table', label: 'table', type: 'table' }] },
