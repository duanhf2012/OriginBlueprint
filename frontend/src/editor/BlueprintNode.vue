...
.label-boolean { color: #ff3945; }.label-string { color: #f032c0; }.label-integer, .label-number { color: #24c442; }.label-float { color: #5bd2b2; }.label-array { color: #e0b820; }.label-file { color: #84b6e0; }.label-table { color: #47c99d; }.label-dictionary { color: #d98945; }.label-any { color: #55a7e9; }
